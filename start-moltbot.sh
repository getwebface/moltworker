...
if (isOpenAI) {
    ...
    config.models.providers.openai = {
        ...
        models: [
            ...
            { id: 'gpt-5-nano', name: 'GPT-5 Nano', contextWindow: 64000 },
    ...
    // Set the primary model to the most capable "cheap" option
    config.agents.defaults.model.primary = 'openai/gpt-5-mini';
} else if (baseUrl) {
